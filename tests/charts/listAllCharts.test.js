...
test('listAll when there are more than 20 charts', async () => {
    let charts = await testUtils.createArray(25, () => client.charts.create())
...
test('listAll when there are more than 40 charts', async () => {
    let charts = await testUtils.createArray(45, () => client.charts.create())
...
test('listAll Charts with filter', async () => {
    let fooCharts = await testUtils.createArray(21, () => client.charts.create('foo'))
...
test('listAll Charts with tag', async () => {
    let fooCharts = await testUtils.createArray(21, async () => {
