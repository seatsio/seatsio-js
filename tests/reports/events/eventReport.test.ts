...
test('report properties for GA', async () => {
    ...
    expect(reportItem.hasLiftUpArmrests).toBe(undefined)
    expect(reportItem.isHearingImpaired).toBe(undefined)
    expect(reportItem.isSemiAmbulatorySeat).toBe(undefined)
